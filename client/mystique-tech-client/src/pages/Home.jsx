...
const Home = () => {
  return (
    <div className="min-h-screen">
      ...
      >
        <div className="max-w-7xl flex flex-col mx-auto px-4 text-center bg-blue-50/10 w-[50%] backdrop-blur-lg h-[60%] rounded-2xl p-10 hero-txt">
          <h1 className="text-4xl font-elegant  mb-5"> XE-Tech</h1>
          <p className="text-l m-5">Discover beautifully designed tech gadgets that combine style and functionality</p>
          <Link 
  to="/products" 

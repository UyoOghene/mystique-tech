...
const Home = () => {
  return (
    <div className="min-h-screen w-[100vw] md:w-[100vw] lg:[100vw] flex flex-col items-center overflow-hidden">
      <section 
        style={{
        ...
        className="text-white py-20 h-[80vh] md:w-[100vw] lg:[100vw] flex flex-col items-center "
      >
